...
const ZIP_DIST = path.resolve(__dirname, 'collab-timer');
...
module.exports = {
    ...
    plugins: [
        new CleanWebpackPlugin([DIST_DIR, path.resolve(__dirname, 'collab-timer'), path.resolve(__dirname, 'collab-timer.zip')]),
        ...
        IS_PRODUCTION ? new ZipFilesPlugin({
            entries: [{ src: DIST_DIR, dist: '/collab-timer' }],
            output: ZIP_DIST,
            format: 'zip'
        }) : new Function()
    ],
